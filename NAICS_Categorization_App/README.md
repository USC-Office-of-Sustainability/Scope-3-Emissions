...
- [Rscript for pre-processing data before training model or predicting output here](https://github.com/USC-Office-of-Sustainability/Scope-3-Emissions/edit/main/NAICS_Categorization_App/README.md#:~:text=Processing_prior_to_LLM.R)
- [Python script just for pre-procesing before training the model here](https://github.com/USC-Office-of-Sustainability/Scope-3-Emissions/blob/main/NAICS_Categorization_App/prepare_NAICS_data.py)
